...
export const PROJECT_CARD_SIZES = {
  oneColumn: '(max-width: 1366px) 48vw, (max-width: 1919px) 42vw, 720px',
  twoColumns: '(max-width: 1366px) 94vw, (max-width: 1919px) 46vw, 960px',
}
...
export const IMAGE_DIMENSIONS = {
  card: { width: 840, height: 473 },
  cardSmall: { width: 460, height: 259 },
  gallery: { width: 1400, height: 900 },
}
